<?php
/**
 * gallery.php - gallery viewer class for Digital Orlando
 */

require_once VIEW_DIR."html_builder.php";

/**
 * load and initialise Gallery Viewer class for Digital Orlando
 */
class GalleryViewer extends BuildHTML {
	...
	$img_attributes = array("id"=>$img_id,"class"=>GALLERY_IMG,"title"=>$img_desc,"alt"=>$img_name,"src"=>MEDIA_IMAGES_DIR.$img);
	$link_attributes = array("href"=>'?node=content/image&id='.$img_id,"class"=>GALLERY_LINK,"title"=>"Open image page");
